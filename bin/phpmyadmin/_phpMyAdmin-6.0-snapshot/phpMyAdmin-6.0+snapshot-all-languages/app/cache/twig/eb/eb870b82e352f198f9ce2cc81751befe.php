...
class __TwigTemplate_af3cff74a51dae7c38baf86e9ac091ae extends Template
{
...
<input type=\"hidden\" id=\"webauthn_request_response\" name=\"webauthn_request_response\" value=\"\" data-request-options=\"";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["request_options"] ?? null), "html_attr");
        yield "\">
";
        yield from [];
    }
    ...
    {
        return new Source("", "login/twofactor/webauthn_request.twig", "/mnt/storage/phpmyadmin.git/release/phpMyAdmin-6.0+snapshot/resources/templates/login/twofactor/webauthn_request.twig");
    }
}
