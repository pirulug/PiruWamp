...
class __TwigTemplate_cce25fbd3b5bd08b34894a0aaabf9848 extends Template
{
    ...
    ";
            // line 3
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(($context["recent"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 4
    ...
    ";
            // line 14
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(($context["favorite"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 15
                yield "      <div class=\"col-auto dropdown\">
        <button title=\"";
                // line 16
...
";
    ...
    {
        return new Source("", "navigation/tree/quick_warp.twig", "C:\\Pirulug\\PiruWamp\\bin\\phpmyadmin\\_phpMyAdmin-6.0-snapshot\\phpMyAdmin-6.0+snapshot-all-languages\\resources\\templates\\navigation\\tree\\quick_warp.twig");
    }
}
