...
import threading
from ..managers.php_repository import PHPRepository
from ..core.config import config
from ..core.logger import logger
from .theme import apply_theme

class PHPManagerWindow(tk.Toplevel):
    def __init__(self, parent_app):
        super().__init__(parent_app.root)
        self.title("Gestor de Versiones de PHP")
    ...
    def _setup_ui(self):
        ...
        tk.Label(main_frame, text="Versiones de PHP Disponibles", font=("Arial", 12, "bold")).pack(pady=(0, 10))
    ...
    def refresh_list(self):
        ...
        active = config.active_php_version
    ...
    def activate_version(self, name):
        config.set_php_version(name)
        messagebox.showinfo("PHP", f"Versión {name} activada.\nSe actualizarán las configuraciones al iniciar Apache.")
        self.refresh_list()
        # Notificar a la app principal para actualizar menús
